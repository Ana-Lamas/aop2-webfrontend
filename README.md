...
1.  **`index.html` (Home):** Página principal que lista os artigos mais recentes em formato de "card".
2.  **`one-piece-tritoes.html` (Artigo):** Exemplo de uma página de artigo/análise.
3.  **`frieren-mundo.html` (Artigo):** Exemplo de uma página de artigo/análise.
4.  **`fullmetal-quimica.html` (Artigo):** Exemplo de uma página de artigo/análise.
5.  **`contatos.html` (Contato):** Página com um formulário de contato funcional (front-end).
...
* **HTML5 Semântico:** Uso correto de tags como `<header>`, `<footer>`, `<main>`, `<nav>`, `<article>` e `<section>` para estruturar o conteúdo de forma lógica e acessível.
* **CSS3:**
    * **Flexbox:** Utilizado para criar todos os layouts principais, incluindo o alinhamento do cabeçalho e o grid de cards na página inicial.
...
* **Ana Caroline Lamas Rosa Corteletti**
* **Pablo de Souza**
